    ...
    <main className="grid grid-cols-6 h-[75vh] overflow-hidden">
      ...
      <section className="col-span-4 overflow-auto pl-8 pr-32">
        ...
        <p className="text-lg">
          ...
          isn&apos;t so straightforward. I find that I&apos;m always pulling the past behind me as I
          move into new phases of my work. What came before never really wants to let go. If you
          take a quick glance through my instagram you&apos;ll see lots and lots of empty spaces,
          but scroll back farther and you&apos;ll see a few years worth of portraits. Not to mention
          the occasional editorial or street series peppered in. The truth is I&apos;m not closed
          off to any concept, and this, combined with the art-adjacent nature of Medium Format
        ...
        <ul>
          ...
          <li>
            ...
            city. I&apos;ve lived in NYC for over a decade and don&apos;t see myself leaving anytime
            soon. I do enjoy taking trips out whenever possible.
          </li>
          <li>
